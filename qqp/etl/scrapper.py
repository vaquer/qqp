        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=200) as executor:
            for category_id in range(len(self.main_categories)):
                ...
                if title.strip() != '':
                    ...
                    queue_task.append(executor.submit(self.set_verbose_category, **parameters))
    ...
    def set_regions(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=200) as executor:
            for city in self.cities:
                ...
                queue_task.append(executor.submit(self.http_qqp_async, **params))
...
class Prices(Connector):
    ...
    def download_prices(self, http_params={}, product_id=None, brand=None, id_brand=None):
